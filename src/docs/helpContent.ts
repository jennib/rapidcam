...
export const HELP_TOPICS: HelpTopic[] = [
    ...
    sections: [
      {
        ...
        tips: [
          ...
          "Line Tool (L): Click start point, then click end point. Hold (Shift) to lock orthogonal 0°, 45°, or 90° angles. Continuous chaining is supported.",
          "Polyline Tool (P): Draw connected multi-segment chains of lines and arcs. Double-click or press (Enter) to close the contour or (Esc) to finish.",
          "Rectangle Tool (R): Click first corner, then drag or click the opposite corner. Switch between corner-to-corner or center-out in properties.",
          "Circle Tool (C): Click center point and drag outward to define radius, or enter exact diameter in the input HUD.",
          "Arc Tool (A): 3-Point Arc creation (Center → Start → End, or 3-Point perimeter). Press (Tab) during drawing to flip arc bulge direction.",
    ...
    sections: [
      {
        ...
        tips: [
          ...
          "Rotate Tool (Q): Select entities, define a center pivot point, and enter an exact angle of rotation.",
          "Scale Tool (S): Uniformly or non-uniformly resize geometry about an origin reference point.",
        ],
      },
      {
  ...
  // ==========================================
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "RapidCAM supports 18 distinct geometric constraint types. Select the relevant entities and click the constraint button or press the shortcut key:",
        table: {
          headers: ["Constraint", "Glyph", "Key", "Description & Entity Requirements"],
          rows: [
            ["Coincident", "[+]", "C", "Binds 2 endpoints together, or pins a point to a circle/arc center."],
            ["Horizontal", "[H]", "H", "Forces a line horizontal, or aligns 2 points along the same Y level."],
            ["Vertical", "[V]", "V", "Forces a line vertical, or aligns 2 points along the same X position."],
            ["Parallel", "[∥]", "P", "Locks two lines to share the exact same slope/angle."],
            ["Perpendicular", "[⟂]", "K", "Locks two lines to maintain a strict 90° right angle."],
            ["Equal", "[=]", "E", "Enforces identical length on 2 lines, or identical radius on 2 circles/arcs."],
  ...
  // ==========================================
  {
    ...
    summary: "In-depth guide to 2D Profile milling, pocketing strategies, V-carving, drilling, 3D holding tabs, and dogbone corner reliefs.",
    keywords: [
      "cam",
      "profile",
      "contour",
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["L", "Line Tool", "Click start point then end point. Hold Shift for orthogonal lock."],
            ["R", "Rectangle Tool", "Click corner to corner, or drag out dimensions."],
            ["C", "Circle Tool", "Click center point then drag radius, or input diameter."],
            ["A", "Arc Tool", "Click Center → Start → End. Tab key flips arc direction."],
            ["P", "Polyline Tool", "Click sequential vertices. Double-click or Enter closes loop."],
            ["B", "Bezier / Spline", "Click anchor points and adjust curve tangent handles."],
            ["U", "Slot Tool", "Click two slot centers, then drag width."],
            ["N", "Polygon Tool", "Click center then vertex to draw regular N-sided polygons."],
            ...
            ["Q", "Rotate Tool", "Select objects, pick pivot center, and enter angle."],
