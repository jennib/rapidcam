...
function sharePopup(url: string): void {
  window.open(url, "rapidcam-share", "width=600,height=400,noopener,noreferrer");
}
...
export function showShareDialog(): void {
  ...
  socialRow.style.cssText = "display:flex;gap:8px;justify-content:center;flex-wrap:wrap;";
