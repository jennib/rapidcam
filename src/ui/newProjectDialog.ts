...
export function openNewProjectDialog(
  ...
  infoIcon.title = "The Work Coordinate System (WCS) origin is the physical 0,0,0 starting point on your CNC machine.";
  originSec.firstElementChild?.appendChild(infoIcon);
  const oxSel = sel([
    ["left", "Left"],
    ["center", "Center"],
    ["right", "Right"],
